/**
 * Seed Copa do Mundo 2026 — Fase de Grupos
...
// ── Grupos e seleções ──────────────────────────────────────────────────────────
// [t1, t2, t3, t4] — R1: t1×t2 | t3×t4 | R2: t1×t3 | t2×t4 | R3: t1×t4 | t2×t3
...
// ── Calendário ─────────────────────────────────────────────────────────────────
// UTC. Rodada 1: Jun 11-16 | Rodada 2: Jun 17-22 | Rodada 3: Jun 23-28
// Grupos pares (A,C,E,G,I,K): 16:00 e 19:00 UTC
// Grupos ímpares (B,D,F,H,J,L): 22:00 e 01:00+1 UTC
// Rodada 3: simultâneas dentro do grupo (mesma hora)

interface DatePair { m1: string; m2: string }

const CALENDARIO: Record<string, [DatePair, DatePair, DatePair]> = {
...
async function main() {
  ...
  // 1. Limpar dados cravou (mantém usuários)
  ...
  // 2. Criar standings (tabela zerada para cada seleção)
  ...
  // 3. Criar as 72 partidas da fase de grupos
  ...
  // 4. Criar todos os slots do chaveamento (vazios, para preenchimento manual)
