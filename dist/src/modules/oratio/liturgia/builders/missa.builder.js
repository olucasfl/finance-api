...
exports.buildMissa = buildMissa;
function buildMissa(data) {
...
Amém.`
            ...
            },
            {
                ...
                conteudo: {
                    tituloOracaoEucaristica: oracaoEucaristica === 2
                    ...
                    convite: [
                        ...
                        {
                            assembleia: "Receba o Senhor por tuas mãos este sacrifício, para glória do seu nome, para nosso bem e de toda a sua santa Igreja."
                        }
                    ],
                    prefacio: {
                        dialogo: [
...
Hosana nas alturas.`,
                    inicioOracaoEucaristica: oracaoEucaristica === 2
                        ? [
                            {
            ...
            um sacrifício perfeito.`
                    ...
                    epicleseAntesConsagracao: oracaoEucaristica === 2
                        ? [
                            {
                ...
                de vosso Filho, nosso Senhor Jesus Cristo.`
                    ...
                    consagracao: oracaoEucaristica === 2
                        ? [
                            {
...
partiu e o deu a seus discípulos, dizendo:
            ...
            FAZEI ISTO EM MEMÓRIA DE MIM.`
                    ...
                    posConsagracao: oracaoEucaristica === 2
                        ? {
                            anamnese_oblacao: [
                                {
...
todos os vossos filhos e filhas dispersos pelo mundo inteiro.`
                    ...
                    doxologia: [
                        {
                            padre: "Por Cristo, com Cristo e em Cristo, a vós, Deus Pai todo-poderoso, na unidade do Espírito Santo, toda honra e toda glória, por todos os séculos dos séculos."
                        },
                        { assembleia: "Amém." }
                    ],
                }
...
//# sourceMappingURL=missa.builder.js.map